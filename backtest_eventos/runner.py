...
from indicators import build_feature_library


def ensure_pyeventbt_available(local_repo_dir: str = "pyeventbt-main"):
    """
    Intenta importar pyeventbt.
    Si no esta instalado, intenta usar el repo local `pyeventbt-main`.
    """
    try:
        import pyeventbt  # noqa: F401
        return
    except Exception:
...
def run_event_backtest(
    *,
    ...
    local_pyeventbt_repo: str = "pyeventbt-main",
    ...
    ensure_pyeventbt_available(local_repo_dir=local_pyeventbt_repo)
